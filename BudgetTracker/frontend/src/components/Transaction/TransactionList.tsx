...
const TransactionList: FC<TransactionListProps> = ({ transactions }) => {
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border dark:border-gray-600">
      ...
      <div className="space-y-3">
        {transactions.map((transaction) => {
          ...
          return (
            <div
              key={transaction.id}
              className="flex justify-between items-start sm:items-center p-3 sm:p-4 border dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
            >
